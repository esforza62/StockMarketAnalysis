...
SECTOR_OVERRIDES = {
    ...
    # Added alongside the user's TradingView watchlist import -- ETFs/ETNs
    # first (a fund isn't a single-GICS-sector company, so "ETF" is the
    # correct bucket, not a guess), then non-S&P-500 individual companies
    # (foreign large caps/ADRs, small/mid caps, recent IPOs) hand-mapped
    # by GICS sector. EE, EFOR, and RONB were left OUT of both override
    # dicts entirely -- not confidently identifiable from the ticker alone,
    # so they fall through to "Unknown" (still fully trackable at the
    # symbol tier, just without the industry/sector fallback benefit) until
    # confirmed rather than risk mapping them to the wrong sector.
    "BITC": "ETF", "BOIL": "ETF", "DYNF": "ETF", "GDX": "ETF", "GDXJ": "ETF",
    "GLD": "ETF", "GLIN": "ETF", "HYG": "ETF", "IBIT": "ETF", "IEMG": "ETF",
    "IGPT": "ETF", "IGV": "ETF", "ITA": "ETF", "IVW": "ETF", "IWB": "ETF",
    "IWD": "ETF", "IWF": "ETF", "IWO": "ETF", "IWV": "ETF", "JEPQ": "ETF",
    "JETS": "ETF", "KOLD": "ETF", "KQQQ": "ETF", "MDY": "ETF", "MSFO": "ETF",
    "PWB": "ETF", "QQEW": "ETF", "QQQE": "ETF", "RSP": "ETF", "SIL": "ETF",
    "SMH": "ETF", "SMLF": "ETF", "SPXT": "ETF", "SPYU": "ETF", "TLT": "ETF",
    "TQQQ": "ETF", "TZA": "ETF", "UNG": "ETF", "URNM": "ETF", "VB": "ETF",
    "VOO": "ETF", "VTHR": "ETF", "VXF": "ETF",
    "ADC": "Real Estate",
    "AFRM": "Financials",
...
INDUSTRY_OVERRIDES = {
    ...
    "TQQQ": "ETF", "TZA": "ETF", "UNG": "ETF", "URNM": "ETF", "VB": "ETF",
    "VOO": "ETF", "VTHR": "ETF", "VXF": "ETF",
    "ADC": "Equity Real Estate Investment Trusts (REITs)",
    "AFRM": "Financial Services",
    "AI": "Software & Services",
    "ALK": "Transportation",
    "ALLT": "Software & Services",
    "AMC": "Media & Entertainment",
    "ANF": "Consumer Discretionary Distribution & Retail",
    "ARW": "Technology Hardware & Equipment",
    "BABA": "Consumer Discretionary Distribution & Retail",
    "BIDU": "Media & Entertainment",
    "BNTX": "Pharmaceuticals, Biotechnology & Life Sciences",
    "BRK-A": "Insurance",
    "CHWY": "Consumer Discretionary Distribution & Retail",
    "DJT": "Media & Entertainment",
    "DKNG": "Consumer Services",
    "DOCU": "Software & Services",
    "EA": "Media & Entertainment",
    "ENPH": "Technology Hardware & Equipment",
    "ENVX": "Technology Hardware & Equipment",
    "EWBC": "Banks",
    "EXEL": "Pharmaceuticals, Biotechnology & Life Sciences",
    "FBP": "Banks",
    "FIVE": "Consumer Discretionary Distribution & Retail",
    "GCT": "Consumer Discretionary Distribution & Retail",
    "IONQ": "Software & Services",
    "JBLU": "Transportation",
    "JD": "Consumer Discretionary Distribution & Retail",
    "LAC": "Materials",
    "LCID": "Automobiles & Components",
    "LI": "Automobiles & Components",
    "MDB": "Software & Services",
    "MHO": "Consumer Durables & Apparel",
    "NET": "Software & Services",
    "NNN": "Equity Real Estate Investment Trusts (REITs)",
    "NVAX": "Pharmaceuticals, Biotechnology & Life Sciences",
    "NVO": "Pharmaceuticals, Biotechnology & Life Sciences",
    "OKTA": "Software & Services",
    "PFGC": "Consumer Staples Distribution & Retail",
    "PINS": "Media & Entertainment",
    "PLUG": "Capital Goods",
    "QBTS": "Software & Services",
    "QMCO": "Technology Hardware & Equipment",
    "QSI": "Health Care Equipment & Services",
    "QUBT": "Software & Services",
    "RGTI": "Software & Services",
    "RIVN": "Automobiles & Components",
    "ROKU": "Media & Entertainment",
    "RY": "Banks",
    "SITM": "Semiconductors & Semiconductor Equipment",
    "SLDP": "Capital Goods",
    "SNAP": "Media & Entertainment",
    "SNOW": "Software & Services",
    "SOFI": "Financial Services",
    "SOUN": "Software & Services",
    "SPOT": "Media & Entertainment",
    "STLA": "Automobiles & Components",
    "TM": "Automobiles & Components",
    "TNET": "Commercial & Professional Services",
    "TSM": "Semiconductors & Semiconductor Equipment",
    "UEC": "Energy",
    "UL": "Household & Personal Products",
    "USFD": "Consumer Staples Distribution & Retail",
    "VFS": "Automobiles & Components",
}
