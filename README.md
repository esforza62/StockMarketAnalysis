...
-- classic crossover and breakout signals (RSI and Bollinger mean reversion, MACD
crossover, EMA 20/50 trend cross, Donchian breakout, Supertrend), a family of VWAP
strategies, RSI+MACD and RSI dip-recovery combinations, and three readings of the
Volume Flow Indicator (zero-line state, signal-line cross, bullish divergence) --
across any list of tickers,
